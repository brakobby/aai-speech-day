...
export default function Newsletter() {
  return (
    <>
      <PageHero
        title="Newsletter"
        subtitle="Download the School Newsletter &amp; Programme Booklet"
      />

      <section className="section">
        <div className="container">
          <div className="section-header">
            <p className="eyebrow">School Publications</p>
            <h2>Newsletter <em>&amp; Booklet</em></h2>
          ...
          <div className="download-grid">
            <div className="booklet-preview">
              ...
              <div className="booklet-preview-overlay">
                ...
                <span>Official Newsletter &amp; Booklet</span>
            ...
            <div className="download-info">
              <h2>
                School <em>Newsletter</em><br />&amp; Booklet, 2026
              </h2>
              <p>
                The 2026 end-of-year newsletter and programme booklet features the full
                ceremony order of events, prize category listings, a message from the
                Principal, school highlights from the year, student achievements, and
                the complete prize recipients list.
              </p>
