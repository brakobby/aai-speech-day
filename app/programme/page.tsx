    ...
    cols: [
      {
        ...
        entries: [
          { label: 'Socially Responsible',      text: 'Grade 12 Award' },
          { label: 'Giving Back to School',     text: 'Grade 12 Award' },
          { label: 'Class Recognition',         text: 'Class of 2026' },
          { label: 'Class Recognition',         text: 'Class of 2026' },
          { label: 'Class Recognition',         text: 'Class of 2026' },
        ],
      },
      {
        ...
        entries: [
          ...
          { label: 'Star Pupil',          text: 'Star Pupil Award' },
          { label: 'Most Improved',       text: 'Most Improved Student' },
          { label: 'Exemplary Leader',    text: 'Exemplary Leader Award' },
          { label: 'Perfect Attendance',  text: 'Perfect Attendance Award' },
        ],
      },
    ],
  },
